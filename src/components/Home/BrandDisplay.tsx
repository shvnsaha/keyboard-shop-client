...
const BrandDisplay = () => {
    const brandsData = [
        ...
        { id: 3, logo: 'https://i.ibb.co/0Ff4pgM/corsiar.png', title: 'Corsair' },
    ...
    return (
        <div className="mx-auto overflow-hidden px-4 py-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 " >
                {
                    brandsData.map(item =>
                        ...
                        <div key={item.id} className='col-span-1  cursor-pointer group border-2 bg-base-200 hover:shadow-xl rounded-xl p-2' data-aos='fade-left' data-aos-delay='600'>
